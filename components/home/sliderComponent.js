    ...
    return(
        <ScrollView horizontal>
            ...
            <View>
             ...
             <Text style={styles.number}>{addCommas(data?.country?.result?.cases)||'N/A'}</Text>
             <Text style={styles.status}>Confirmed Cases</Text>
            </View>
           {/* Recovered */}
           <View>
             <Image source={require('../../assets/recovery.png')} style={styles.image} />
             <Text style={styles.number}>{addCommas(data?.country?.result?.recovered)||'N/A'}</Text>
             <Text style={styles.status}>Recovered</Text>
            </View>
              {/* Deaths */}
           <View>
             <Image source={require('../../assets/deaths.jpeg')} style={styles.image} />
             <Text style={styles.number}>{addCommas(data?.country?.result?.deaths) || 'N/A' }</Text>
